export const metadata = {
  title: "Firebase Phone Authentication Setup in a React Native App with Expo",
...
# 📱 Firebase Phone Authentication Setup in a React Native App with Expo
...
npm @react-native-async-storage/async-storage@2.1.2 zustand@^5.0.6
