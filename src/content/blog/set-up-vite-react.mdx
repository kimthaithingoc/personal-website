export const metadata = {
  ...
  publishDate: "2024-05-01T07:00:00Z",
  description:
    "Learn how to set up a modern React boilerplate using Vite, TypeScript, ESLint, Prettier, Vitest, React Testing Library, React Router, and advanced Git tools like Husky, Lint-Staged, and Commitlint. This step-by-step guide helps you create a scalable and high-performance React project from scratch.",
...
Includes: **Vite + React + TypeScript + ESLint + Prettier + Vitest + React Testing Library + React Router + Husky + Lint-Staged + Commitlint**
