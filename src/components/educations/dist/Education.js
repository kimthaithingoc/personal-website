...
var EducationCard_1 = require("./EducationCard");
var data_1 = require("@/lib/data");
var Education = function () {
    var t = next_intl_1.useTranslations("Education");
    ...
    return (react_1["default"].createElement("section", { ref: sectionRef, className: "py-4 space-y-4", id: "experience" },
        ...
        data_1.educations.map(function (education, index) { return (react_1["default"].createElement(EducationCard_1["default"], { key: education.id, education: education, sectionRef: sectionRef, index: index, educationLength: data_1.educations.length })); })));
};
