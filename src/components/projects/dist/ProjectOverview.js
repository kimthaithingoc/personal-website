...
var ProjectOverview = function (_a) {
    ...
    return (react_1["default"].createElement("div", null,
        project.videoDemo ? (react_1["default"].createElement("div", { className: "w-full aspect-video" },
            react_1["default"].createElement("iframe", { className: "w-full h-full rounded-md", src: project.videoDemo, title: project.title, allow: "accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture", allowFullScreen: true }))) : (react_1["default"].createElement("div", { className: "w-full aspect-video relative" },
