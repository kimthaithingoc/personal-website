...
exports.CarouselNext = exports.CarouselPrevious = exports.CarouselItem = exports.CarouselContent = exports.Carousel = exports.type = exports.useCarousel = void 0;
...
function Carousel(_a) {
    ...
    return (React.createElement(CarouselContext.Provider, { value: {
        ...
        React.createElement("div", __assign({ onKeyDownCapture: handleKeyDown, className: utils_1.cn("relative", className), role: "region", "aria-roledescription": "carousel", "data-slot": "carousel" }, props), children)));
}
...
function CarouselContent(_a) {
    ...
    return (React.createElement("div", { ref: carouselRef, className: "overflow-hidden", "data-slot": "carousel-content" },
        React.createElement("div", __assign({ className: utils_1.cn("flex", orientation === "horizontal" ? "-ml-4" : "-mt-4 flex-col", className) }, props))));
}
exports.CarouselContent = CarouselContent;
function CarouselItem(_a) {
    var className = _a.className, props = __rest(_a, ["className"]);
    var orientation = useCarousel().orientation;
    return (React.createElement("div", __assign({ role: "group", "aria-roledescription": "slide", "data-slot": "carousel-item", className: utils_1.cn("min-w-0 shrink-0 grow-0 basis-full", orientation === "horizontal" ? "pl-4" : "pt-4", className) }, props)));
}
...
function CarouselPrevious(_a) {
    ...
    return (React.createElement(button_1.Button, __assign({ "data-slot": "carousel-previous", variant: variant, size: size, className: utils_1.cn("absolute size-8 rounded-full", orientation === "horizontal"
...
function CarouselNext(_a) {
    ...
    return (React.createElement(button_1.Button, __assign({ "data-slot": "carousel-next", variant: variant, size: size, className: utils_1.cn("absolute size-8 rounded-full", orientation === "horizontal"
